...
(function(){
  ...
  var KB = [
    ...
    // ---- 第2课:二自由度模型 ----
    {k:'二自由度|2dof|两自由度',
     a:'<b>二自由度模型</b>是分析车辆操纵稳定性的基础。两个自由度是:<b>横摆角速度 r</b>(车绕竖直轴旋转)和<b>质心侧偏角 β</b>(车身侧向滑移)。<br><br>核心公式(第2课):<br>• 稳态横摆: <b>r = [1/(1+K·V²)] · (V/l) · δf</b><br>• 稳定系数: <b>K = −(m/2l²)·(lf·Kf − lr·Kr)/(Kf·Kr)</b><br>• 临界车速(OS): <b>Vc = √(−1/K)</b><br><br>K>0→不足转向(推头), K<0→过度转向(甩尾), K=0→中性。详见<b>第2课</b>~'},
    ...
    {k:'公式|equation|数学',
     a:'书中关键公式:<br>• 摩擦圆: <b>√(Fx²+Fy²) ≤ μFz</b><br>• 稳态横摆: <b>r = [1/(1+KV²)]·(V/l)·δf</b><br>• 稳定系数: <b>K = −(m/2l²)·(lf·Kf−lr·Kr)/(Kf·Kr)</b><br>• 回正力矩: <b>Ts = (rτ+tp)·Fy</b><br>• DYC力矩: <b>M = (F右−F左)×Tr/2</b><br>• 预瞄时间: <b>T = 注视距离/车速</b><br>想看具体推导,请翻阅对应课程~'},
    {k:'谢谢|感谢|thanks|多谢',
     a:'不客气!继续问我吧~ 😊 有问题随时找我 🍉'},
    {k:'再见|拜拜|bye',
     a:'拜拜~ 🍉 记得去上课哦!首页就有~'},
